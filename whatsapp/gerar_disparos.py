...
def aniversario_proximo(data_nasc, janela_dias: int = 15):
    ...
    diff = (aniv - hoje).days
    return (-janela_dias <= diff <= 0), (aniv.month == hoje.month and diff > 0)
...
def main():
    ...
    stats: dict = {"aniversario": 0, "orcamento_aberto": 0,
                   "agenda_ativa": 0, "paciente_antigo": 0}
    linhas = []
