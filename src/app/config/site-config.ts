  ...
  reviews: [
    {
      ...
      avatar: 'SC',
      rating: 5,
      text: 'Profissional excelente, atenciosa e está sempre se atualizando e se especializando. Os resultados de harmonização orofacial, como preenchimento labial e o ultrassom microfocado trazem resultados de verdade.',
      date: 'há 1 semana',
    },
    {
      ...
      avatar: 'GS',
      rating: 5,
      text: 'A Dra. Daiana é perfeita, detalhista, preenchimento labial ficou maravilhoso!! Amei!',
      date: 'há 1 semana',
    },
    {
      ...
      avatar: 'MH',
      rating: 5,
      text: 'Ótima dentista e lugar super agradável! Fiz um ultrassom microfocado, adorei! Ficou simplesmente maravilhoso. Sem contar a Dra que é super gentil e atenciosa!! Também fiz um peeling coreano!! Ameiiii!',
      date: 'há 1 semana',
    },
    {
      ...
      avatar: 'HS',
      rating: 5,
      text: 'Foi maravilhoso!! Adorei o atendimento e cuidado! Eu indico e volto sempre!!',
      date: 'há 1 semana',
    },
    {
      ...
      avatar: 'DC',
      rating: 5,
      text: 'Muito profissional, dedicada. Estou muito satisfeito com o tratamento estético. Recomendo. Pode confiar.',
      date: 'há 6 dias',
    },
    {
      ...
      avatar: 'DO',
      rating: 5,
      text: 'Excelente profissional, se atualiza sempre para trazer novidades aos pacientes e ainda é super justa e carismática!',
      date: 'há 1 semana',
    },
    {
      author: 'Karina Rosa',
      avatar: 'KR',
      rating: 5,
      text: 'Fiz ultrassom microfocado na clínica e adorei o resultado!',
      date: 'há 1 semana',
    },
    {
      ...
      avatar: 'AC',
      rating: 5,
      text: 'Excelente profissional! Cuidadosa, experiente e atenciosa. Recomendo!!!',
      date: 'há 1 semana',
    },
    {
      ...
      avatar: 'KM',
      rating: 5,
      text: 'Tive uma experiência excelente com a Dra. Daiana. Além de ser uma profissional extremamente competente e técnica, fiquei impressionada com o seu lado humano. Ela trata os pacientes com muita atenção, paciência e cuidado.',
      date: 'há 3 meses',
    },
    {
      ...
      avatar: 'JO',
      rating: 5,
      text: 'Fiz um implante com a Dra. Daiana e fui muito bem acolhida. Ela é uma profissional muito competente, soube resolver minha dor com bastante cautela e profissionalismo. Eu recomendo muito.',
      date: 'há 9 meses',
    },
    {
      ...
      avatar: 'IG',
      rating: 5,
      text: 'A Dra. Daiana é espetacular! Atendimento extremamente humanizado, explicações claras do tratamento e muito atenciosa no pós-tratamento! Recomendo muito!',
    ...
    },
    {
      ...
      avatar: 'EO',
      rating: 5,
      text: 'Fomos muito bem acolhidas, atendimento excelente, lugar limpo. Indico a todos que conheço!!!',
      date: 'há 1 ano',
    },
  ],
